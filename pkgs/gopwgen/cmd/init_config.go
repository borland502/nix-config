...
var initConfigCmd = &cobra.Command{
	Use:   "init-config",
	Short: "Write a starter config file for password generation",
	Long: fmt.Sprintf(
		"Write a starter TOML config file for password generation to the default XDG location (%s). Use --config to target a different path.",
