...
digraph process {
    ...
    "Use nix-config-tools:finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use nix-config-tools:finishing-a-development-branch";
}
```
...
- **nix-config-tools:requesting-code-review** - Code review template for reviewer subagents
